...
- GitHub Actions CI lives in `.github/workflows/ci.yml` and runs shellcheck, bash syntax checks, Python compile checks, and the local BATS wrapper smoke test on pull requests to `main`.
