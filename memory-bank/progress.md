...
- Azure pipeline planning for dependency/bootstrap, lint, and review is documented; a separate secret rotation helper is also planned; implementation has not started.
...
## Next Steps
- Await approval to implement the Azure pipeline workflow, then the secret rotation helper.
