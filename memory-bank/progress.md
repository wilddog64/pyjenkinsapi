...
- Azure pipeline planning for lint and review is documented, including a thin backend-bootstrap wrapper; implementation has not started.
...
- Wrapper/bootstrap direction recorded as part of the Azure pipeline plan.

## Next Steps
- Await approval to implement the Azure pipeline workflow.
