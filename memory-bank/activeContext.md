...
- Azure pipeline planning for `pyjenkinsapi` is now queued: dependency/bootstrap, lint, and code review stages; no implementation yet.
...
- Next task: implement the Azure pipeline plan in `docs/plans/2026-05-03-azure-pipeline-lint-review.md` after approval, including the dependency/bootstrap stage and lint backend wrapper.
