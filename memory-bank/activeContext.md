...
- `setup.py` now declares the runtime dependency stack for `jenkins-cmd`, including `jenkins-webapi==0.5.3`, so reinstalling the package in the active Python environment should resolve the missing `jenkins` module.
