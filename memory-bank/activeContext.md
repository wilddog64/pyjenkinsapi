...
- Keep the Azure repo upload helper's prompt-on-missing behavior aligned with Azure CLI defaults and existing Azure remotes when values are not provided.
